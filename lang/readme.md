...
Translating Meet
======================
The translation of Meet is handled editing manually the language files.

Development
===========
If you want to add new functionality for Meet and you have texts that need to be translated you must add key and value in main.json file in English for each translatable text.
